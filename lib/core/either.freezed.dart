...
class _$LeftImpl<L, R> implements Left<L, R> {
...
abstract class Left<L, R> implements Either<L, R> {
  factory Left(final L value) = _$LeftImpl<L, R>;
...
class _$RightImpl<L, R> implements Right<L, R> {
...
abstract class Right<L, R> implements Either<L, R> {
  factory Right(final R value) = _$RightImpl<L, R>;
